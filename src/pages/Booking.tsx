...
const Booking = () => {
  ...
  return <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 pt-32 pb-16">
        <div className="max-w-6xl mx-auto space-y-12 fade-in">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            {machines.map(machine => <div key={machine.name} className="group cursor-pointer" onClick={() => setSelectedMachine(machine.name)}>
      ...
      {selectedMachine && <BookingModal isOpen={!!selectedMachine} onClose={() => setSelectedMachine(null)} machineName={selectedMachine} />}
    </div>;
};
